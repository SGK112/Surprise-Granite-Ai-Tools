...
// Import the populatecountertops function with error handling
let populatecountertops;
try {
    const module = require("./populatecountertops");
    populatecountertops = module.populatecountertops;
    console.log("Successfully imported populatecountertops.js");
} catch (err) {
    console.error("❌ Failed to import populatecountertops.js:", err.message, err.stack);
    process.exit(1);
}
